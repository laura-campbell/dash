...
User.create(first_name:"Patricia", last_name: "Wong", username:"patriciatoto", email: "pwong@gmail.com", password: "toto")
...
#
# Trip.create(user_id: 3, name: "Africa 2018", origin: "JFK", destination: "NMB", departure_date: '2018-07-25', return_date: '2018-08-05', slug: 'africa-2018')
